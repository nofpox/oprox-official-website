...
export const SignupPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 py-16 sm:py-24 flex items-center justify-center">
      <SEOHead
        titleEn="Get Started with OPROX"
        titleAr="ابدأ مع أوب روكس"
        descriptionEn="Select a platform to start your journey in the OPROX ecosystem."
        descriptionAr="اختر المنصة لبدء رحلتك في منظومة أوب روكس."
        path="/signup"
      />
